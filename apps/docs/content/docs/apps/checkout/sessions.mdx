...
stateDiagram-v2
  [*] --> CREATE
  CREATE --> PAY: customer visits /pay/{id}
...
{
  "id": "cs_abc123",
  "payUrl": "http://localhost:3004/pay/cs_abc123",
...
Returns a URL like `http://localhost:3004/pay/cs_link_abc`.
