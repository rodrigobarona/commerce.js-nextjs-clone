...
`@prood/ui` provides the shared UI layer for all Prood applications. It combines shadcn/ui primitives (Radix + Tailwind) with commerce-specific components ported from the upstream Nuxt reference.
