...
| Hosted checkout (Phase 1 — current) | `checkout.prood.com` | `https://checkout.prood.com/c/cs_...` |
| Store-hosted checkout (Phase 2 — planned) | Same as storefront host | `https://demo-store.prood.app/c/cs_...` |
