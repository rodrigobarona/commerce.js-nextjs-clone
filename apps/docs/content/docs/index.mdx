...
All commerce operations go through `apps/api` for consistent auth, OpenAPI contracts, and agent tooling. See [API-centric architecture](/docs/architecture/api-centric).
