...
The [Agency pricing tier](https://prood.app/pricing) is intended for **10+ stores**, unlimited products/orders per store, unlimited custom domains, and dedicated support. Contact hello@prood.com for portfolio pricing before dashboard billing is available.
