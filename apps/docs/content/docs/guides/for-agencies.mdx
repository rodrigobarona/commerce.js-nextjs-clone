...
- **Custom domains** — Attach `shop.clientbrand.com` when the client goes live.
...
The [Agency pricing tier](https://prood.app/pricing) is intended for **10+ stores**, unlimited products/orders per store, and dedicated support. Contact hello@prood.com for portfolio pricing before dashboard billing is available.
