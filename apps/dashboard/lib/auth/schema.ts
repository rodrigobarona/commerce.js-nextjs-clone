// Better Auth schema (Drizzle / Postgres) for the dashboard.
//
// Mirrors the storefront's core tables (user/session/account/verification) so
// both apps share the same Neon database, and adds the organization plugin
